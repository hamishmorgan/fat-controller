...
```text
fat-controller stop [<services>] [flags]
```

## Arguments

- `<services>` — Services to stop (default: all).
...
| `--dry-run` | bool |  | `FAT_CONTROLLER_DRY_RUN` | Preview what would be stopped without triggering. |
